...
-- 대상 DB: MES_DB (MES와 동일 DB, MCS 테이블은 MCS_ 접두어)
-- 실행 방법: DBeaver에서 MES_DB 선택 후 Alt+X (전체 실행)
-- 실행 순서: MCS DDL → 공통코드 데이터 → 더미 데이터
-- ============================================================
...
--   ★ MES 마스터 테이블 FK 참조 (MST_PLANT, MST_WAREHOUSE, MST_ITEM, MST_VENDOR)
--   ★ 동일 DB이므로 JOIN 및 FK 제약 가능
-- ************************************************************

DROP TABLE IF EXISTS MCS_TRANSFER_ITEM;
DROP TABLE IF EXISTS MCS_TRANSFER_ORDER;
DROP TABLE IF EXISTS MCS_PLC_EVENT_LOG;
...
CREATE TABLE MCS_LOCATION_STOCK (
    ...
    LOT_NO          VARCHAR(50)     NOT NULL DEFAULT '' COMMENT 'LOT번호',
...
-- ============================================================
-- 1-11. MCS_PLC_EVENT_LOG - PLC 이벤트 수신 로그
-- ============================================================
CREATE TABLE MCS_PLC_EVENT_LOG (
...
-- ************************************************************
-- PART 2: MCS 전용 공통코드 데이터 (MES_DB의 COM_CODE 테이블에 추가)
-- ************************************************************

-- MCS 전용 그룹코드 (기존 데이터와 충돌 방지: INSERT IGNORE)
...
(15, 'P001', 'WH006', 'Z-S1',  '출하 대기구역',               'SHIPPING',  2, 'Y', 'W015'),
-- WH008 (P002 셀입고창고)
...
( 1, 'P001',  1, 'RM-NCM-001', 'RM-NCM-001-20250118-001', 3500.000,  500.000, 'W016'),
( 2, 'P001',  3, 'RM-ALF-001', 'RM-ALF-001-20250118-001',  170.000,   10.000, 'W016'),
( 3, 'P001',  4, 'RM-PVD-001', 'RM-PVD-001-20250118-001',  450.000,   30.000, 'W016'),
( 4, 'P001',  4, 'RM-CNT-001', 'RM-CNT-001-20250118-001',  185.000,   10.000, 'W016'),
( 5, 'P001',  4, 'RM-PCH-001', 'RM-PCH-001-20250118-001', 8500.000,  500.000, 'W016'),
( 6, 'P001',  6, 'RM-GRP-001', 'RM-GRP-001-20250118-001', 4200.000,  400.000, 'W016'),
( 7, 'P001',  7, 'RM-CUF-001', 'RM-CUF-001-20250118-001',  175.000,   10.000, 'W016'),
( 8, 'P001',  8, 'RM-ELY-001', 'RM-ELY-001-20250118-001', 2600.000,  200.000, 'W016'),
( 9, 'P001',  9, 'RM-SEP-001', 'RM-SEP-001-20250118-001',   82.000,    5.000, 'W016'),
(10, 'P001', 16, 'SF-JEL-001', 'SF-JEL-001-20250122-001', 1500.000,  500.000, 'W016'),
(11, 'P001', 17, 'SF-WET-001', 'SF-WET-001-20250122-001',  800.000,    0.000, 'W016'),
(12, 'P001', 18, 'SF-FMC-001', 'SF-FMC-001-20250122-001',  900.000,    0.000, 'W016'),
(13, 'P001', 20, 'FG-CEL-001', 'FG-CEL-001-20250120-001', 1067.000,  320.000, 'W015'),
(14, 'P001', 21, 'FG-CEL-001', 'FG-CEL-001-20250121-001', 1164.000,  352.000, 'W015'),
(15, 'P002', 23, 'FG-CEL-001', NULL,                        500.000,  100.000, 'W019'),
(16, 'P002', 25, 'RM-BMS-001', 'RM-BMS-001-20250115-001',  138.000,   25.000, 'W019'),
(17, 'P002', 25, 'RM-BMS-002', 'RM-BMS-002-20250115-001',   91.000,    4.000, 'W019'),
(18, 'P002', 26, 'RM-BUS-001', 'RM-BUS-001-20250115-001', 4070.000,  375.000, 'W019'),
(19, 'P002', 26, 'RM-CAS-001', 'RM-CAS-001-20250115-001',   91.000,    4.000, 'W019'),
(20, 'P002', 27, 'FG-MOD-001', 'FG-MOD-001-20250122-001',   18.000,    6.000, 'W019'),
(21, 'P002', 28, 'FG-PCK-001', 'FG-PCK-001-20250120-001',    3.000,    0.000, 'W021'),
(22, 'P002', 28, 'FG-PCK-001', 'FG-PCK-001-20250121-001',    4.000,    0.000, 'W021'),
(23, 'P002', 29, 'FG-PCK-002', 'FG-PCK-002-20250121-001',    3.000,    0.000, 'W021'),
(24, 'P001', 10, 'RM-NMP-001', 'RM-NMP-001-20250118-001', 1600.000,    0.000, 'W016'),
(25, 'P001', 12, 'SF-CSL-001', 'SF-CSL-001-20250122-001',  515.000,    0.000, 'W016'),
(26, 'P001', 13, 'SF-ASL-001', 'SF-ASL-001-20250122-001',  416.000,    0.000, 'W016'),
(27, 'P001', 14, 'SF-CES-001', 'SF-CES-001-20250121-001', 2940.000, 1000.000, 'W016'),
(28, 'P001', 15, 'SF-AES-001', 'SF-AES-001-20250121-001', 3038.000, 1000.000, 'W016'),
(29, 'P001', 15, 'SF-CEL-001', 'SF-CEL-001-20250122-001',  650.000,  200.000, 'W016');
...
(1, 'P001', 'IB-20250118-0001', 'COMPLETED',  'V001', 'WH001', '2025-01-18', '2025-01-18 08:30:00', 'NCM811 양극활물질 5톤 입고',       'W015'),
(2, 'P001', 'IB-20250118-0002', 'COMPLETED',  'V002', 'WH002', '2025-01-18', '2025-01-18 09:30:00', '인조흑연 음극활물질 + 구리포일',    'W015'),
(3, 'P001', 'IB-20250118-0003', 'COMPLETED',  'V004', 'WH003', '2025-01-18', '2025-01-18 10:00:00', '전해액 LiPF6 3000L 입고',          'W015'),
(4, 'P001', 'IB-20250118-0004', 'COMPLETED',  'V003', 'WH003', '2025-01-18', '2025-01-18 11:00:00', '세라믹코팅 분리막 100롤 입고',      'W015'),
(5, 'P001', 'IB-20250118-0005', 'COMPLETED',  'V005', 'WH001', '2025-01-18', '2025-01-18 13:30:00', '알루미늄포일/파우치필름 입고',      'W015'),
(6, 'P002', 'IB-20250115-0001', 'COMPLETED',  'V009', 'WH009', '2025-01-15', '2025-01-15 09:00:00', 'BMS기판/버스바 입고',               'W019'),
(7, 'P001', 'IB-20250125-0001', 'INSPECTING', 'V004', 'WH003', '2025-01-25', '2025-01-25 08:30:00', '전해액 2000L 순도 검수중',          'W015'),
(8, 'P001', 'IB-20250128-0001', 'ARRIVED',    'V001', 'WH001', '2025-01-28', '2025-01-28 14:00:00', 'NCM811 3톤 추가분 도착',            'W015'),
( 9, 'P002', 'IB-20250130-0001', 'PLANNED', 'V009', 'WH009', '2025-01-30', NULL, 'BMS기판 EV 200EA 보충',  'W019'),
(10, 'P001', 'IB-20250202-0001', 'PLANNED', 'V003', 'WH003', '2025-02-02', NULL, '분리막 50롤 보충',       'W015'),
(11, 'P001', 'IB-20250120-0001', 'CANCELLED', 'V006', 'WH001', '2025-01-20', NULL, 'PVDF 바인더 재고 충분 취소', 'W015');
...
(1, 'RM-NCM-001', 'RM-NCM-001-20250118-001',  1, 5000.000, 5000.000, 'STOCKED', 'LOT EP-NCM811-250110-A', 'W016'),
...
(7, 'RM-ELY-001', NULL, NULL, 2000.000, 0.000, 'PENDING', '전해액 순도/수분 검사중', 'W016'),
...
(1, 'P001', 'TF-20250118-0001', 'COMPLETED',    5,  1, '입고대기 → NCM활물질 적치', 'W016'),
(2, 'P001', 'TF-20250118-0002', 'COMPLETED',   11,  8, '검수완료 전해액 → ELY탱크 이송', 'W016'),
(3, 'P001', 'TF-20250122-0001', 'IN_PROGRESS', 20, 22, '완성셀 출하대기 이동', 'W015'),
(4, 'P002', 'TF-20250125-0001', 'REQUESTED',   28, 30, 'EV팩 출하대기 이동', 'W021'),
(5, 'P001', 'TF-20250121-0001', 'CANCELLED',   17, 19, '웻셀 이동 취소 (바로 화성공정)', 'W016');
...
('P001',  1, 'IB_IN', 5000.000,    0.000, 5000.000, 'IB', 'IB-20250118-0001', 1, 'NCM811 양극활물질 5톤 입고',       'W016'),
...
('P001',  9, 'IB_IN',  100.000,    0.000,  100.000, 'IB', 'IB-20250118-0004', 4, '분리막 100롤 입고',               'W016'),
...
('P001',  1, 'OB_OUT',  500.000, 5000.000, 4500.000, 'OB', 'OB-20250120-0001', 1, '양극믹싱 NCM811 투입',            'W016'),
('P001',  3, 'OB_OUT',   30.000,  480.000,  450.000, 'OB', 'OB-20250120-0001', 1, 'PVDF 바인더 투입',                'W016'),
('P001',  4, 'OB_OUT',   10.000,  195.000,  185.000, 'OB', 'OB-20250120-0001', 1, 'CNT 도전재 투입',                 'W016'),
('P002', 21, 'OB_OUT',    3.000,    3.000,    0.000, 'OB', 'OB-20250122-0001', 2, '현대차 EV팩 3SET 납품',           'W021'),
('P001',  1, 'TF_IN',  5000.000,    0.000, 5000.000, 'TF', 'TF-20250118-0001', 1, '입고대기 → NCM파렛트 적치',       'W016'),
('P001',  8, 'TF_IN',  3000.000,    0.000, 3000.000, 'TF', 'TF-20250118-0002', 2, '검수완료 → 전해액탱크 이송',      'W016'),
('P001',  5, 'ADJ_MINUS', 500.000, 9000.000, 8500.000, NULL, NULL, NULL, '파우치필름 실사 조정 (-500EA)', 'W015'),
('P001', 24, 'IB_IN',      2000.000,    0.000, 2000.000, 'IB', 'IB-20250118-0003', 3, 'NMP 용매 2000L 입고',         'W016'),
('P001', 24, 'PRD_ISSUE',   400.000, 2000.000, 1600.000, NULL, NULL, NULL, 'NMP 코팅공정 투입',               'W016'),
('P001', 25, 'PRD_RECEIPT',  515.000,    0.000,  515.000, NULL, 'WO202501220001', 28, '양극슬러리 생산입고',          'W016'),
('P001', 26, 'PRD_RECEIPT',  416.000,    0.000,  416.000, NULL, 'WO202501220002', 29, '음극슬러리 생산입고',          'W016'),
('P001', 27, 'PRD_RECEIPT', 2940.000,    0.000, 2940.000, NULL, 'WO202501210006', 19, '양극(슬리팅) 생산입고',        'W016'),
('P001', 28, 'PRD_RECEIPT', 3038.000,    0.000, 3038.000, NULL, 'WO202501210007', 20, '음극(슬리팅) 생산입고',        'W016'),
('P001', 29, 'PRD_RECEIPT',  650.000,    0.000,  650.000, NULL, 'WO202501220003', 30, '양극전극시트 생산입고',         'W016');
...
-- ============================================================
-- 검증 쿼리 (설치 후 확인용)
-- 기대: ZONE=22, LOCATION=30, LOC_STOCK=29, LOC_TRANS=22,
